 ...
 *
 */
public class NewSignupRequestDTO {
	 ...
	 * @param deviceId
	 */
	public NewSignupRequestDTO(String firstName, String lastName, String username, String email, String password,
			String mobileNumber, String role, Long idSyllabus, Long idMedium, Long idClassStandard,
			Long idSecondaryLanguage, Long idState, Long idSubject, String deviceId) {
		super();
		this.firstName = firstName;
		this.lastName = lastName;
		this.username = username;
	...
	public NewSignupRequestDTO(String firstName, String lastName, String username, String email, String password,
			String mobileNumber, String role, Long idSyllabus, Long idMedium, Long idClassStandard,
			Long idSecondaryLanguage, Long idState, Long idSubject, String deviceId, String referralCode) {
		super();
		this.firstName = firstName;
		this.lastName = lastName;
		this.username = username;
