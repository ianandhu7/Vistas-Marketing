...
//
//public class UploadYoutubeVideoService {
//
//	/**
...
//	List<String> scopes = com.google.common.collect.Lists.newArrayList("https://www.googleapis.com/auth/youtube.upload");
//
//	try
//	{
...
//				UploadYoutubeVideoService.class.getResourceAsStream("/sample-video.mp4"));
//
...
//		System.err.println(
//				"GoogleJsonResponseException code: " + g.getDetails().getCode() + " : " + g.getDetails().getMessage());
//		g.printStackTrace();
//	}
//	catch(IOException e){
