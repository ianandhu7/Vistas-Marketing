...
public class LeadBatchDetailsRequestV3 {
	 ...
	 * @param otp
	 */
	public LeadBatchDetailsRequestV3(@NotBlank String firstName, @NotBlank String lastName, @NotBlank String username,
			@Email String email, @NotBlank @Size(min = 10, max = 12) String mobileNumber,
			...
			Boolean googleOAuthFlag, Long idState, String referralCode, String otp) {
		super();
		this.firstName = firstName;
		this.lastName = lastName;
		this.username = username;
	 ...
	 * 
	 */
	public LeadBatchDetailsRequestV3() {
		super();
