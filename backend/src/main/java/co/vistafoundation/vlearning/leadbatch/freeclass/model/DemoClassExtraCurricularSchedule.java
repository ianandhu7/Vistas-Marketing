 ...
 */
@Entity
@Table(name = "DEMO_CLASS_EXTRA_CURRICULAR_SCHEDULE")
public class DemoClassExtraCurricularSchedule extends UserDateAudit implements Serializable {
	...
	@Column(name = "idDEMO_CLASS_EXTRA_CURRICULAR_SCHEDULE")
	private Long idDemoClassExtraCurricularSchedule;

	@Column(name = "idDEMO_CLASS_EXTRA_CURRICULAR")
	...
	/**
	 * @return the idDemoClassExtraCurricularSchedule
	 */
	public Long getIdDemoClassExtraCurricularSchedule() {
		return idDemoClassExtraCurricularSchedule;
	}

	/**
	 * @param idDemoClassExtraCurricularSchedule the
	 *                                           idDemoClassExtraCurricularSchedule
	 *                                           to set
	 */
	public void setIdDemoClassExtraCurricularSchedule(Long idDemoClassExtraCurricularSchedule) {
		this.idDemoClassExtraCurricularSchedule = idDemoClassExtraCurricularSchedule;
	}
	...
	/**
	 * @param idDemoClassExtraCurricularSchedule
	 ...
	 */
	public DemoClassExtraCurricularSchedule(Long idDemoClassExtraCurricularSchedule, Long idDemoClassExtraCurricular,
			String webExMeetingKey, String webExMeetingUuid, String webExMeetingGuestUserToken,
			String webExMeetingPassword, String webExHostStartMeetingUrl, String webExAttendeeJoinMeetingUrl) {
		super();
		this.idDemoClassExtraCurricularSchedule = idDemoClassExtraCurricularSchedule;
		this.idDemoClassExtraCurricular = idDemoClassExtraCurricular;
		this.webExMeetingKey = webExMeetingKey;
	 ...
	 * 
	 */
	public DemoClassExtraCurricularSchedule() {
		super();
