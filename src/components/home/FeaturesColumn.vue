        ...
        <div class="flip-inner">
          ...
          >
            ...
            <div class="relative z-10 flex flex-col justify-center pt-0.5 pb-1 flex-1 pr-1.5">
              <h3 class="text-[8px] font-black uppercase leading-tight tracking-wide mb-1"
                  :class="themeStore.theme === 'dark' ? 'text-white' : 'text-gray-900'">{{ f.title }}</h3>
          ...
          >
            <div class="flex flex-col items-center">
              <h3 class="text-[11px] font-black uppercase tracking-tight"
                  :class="themeStore.theme === 'dark' ? 'text-white' : 'text-gray-900'">{{ f.title }}</h3>
