  ...
  <div v-else class="flex flex-col h-full">
      ...
      <div class="absolute inset-0 p-6 flex flex-col justify-center pointer-events-none">
        <div class="video-text-overlay max-w-[55%] space-y-4">
          ...
          <div class="transition-all duration-500 transform">
            <h2 class="text-[var(--text-primary)] text-[26px] font-black leading-[1.15] tracking-tight italic drop-shadow-lg">
              {{ videos[currentVideoIndex].headline }}
            </h2>
            <h2 class="text-[var(--accent-purple)] text-[24px] font-black leading-[1.15] tracking-tight whitespace-pre-line drop-shadow-lg">
    ...
    <div class="flex justify-center items-center gap-[8px] py-[12px]">
      <button 
        ...
        class="transition-all duration-300 rounded-full cursor-pointer z-20"
        :style="{
