...
@keyframes goldPulseMobile {
  0%, 100% {
    box-shadow: 0 0 15px rgba(245, 166, 35, 0.15), inset 0 0 10px rgba(245, 166, 35, 0.05);
    border-color: #F5A623;
  }
  50% {
    box-shadow: 0 0 25px rgba(245, 166, 35, 0.45), inset 0 0 15px rgba(245, 166, 35, 0.2);
    border-color: #ffc862;
  }
}
...
@media (max-width: 768px) {
  ...
  /* Best Value card pulse glow on mobile */
